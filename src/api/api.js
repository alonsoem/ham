...
export const postQSOLA = (params) => foreignRequest('get', 'http://ham.qrits.com.ar/api/subeqso2.php',params,{'Content-Type':'Content-Type: text/html','Control-Allow-Origin':'*'});
